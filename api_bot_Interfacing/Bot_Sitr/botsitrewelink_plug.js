...
plug_waiting=[];
plugs_with_water_cooled_miners=["APlug","TPlug"];
plug_ids_wtr_miners=[];
plug_ids=['10012aa1d0','10011f9496','10014908f4','1001490d88','10012aa8ed','10012aa1f6','10012a9ff5','10011f948a','10012aa914','10012aa91c','10015d935b','10015da25a','10015d933e','10015d9375'];
thirdConnection;
ewelink_con;
_email;
_pswrd;
...
// 				break;
			case "LoudmouthPlug":
				//if (plg_info[ix].online&&plg_info[ix].plug_has_power&&(plg_info[ix].status=="off"||plg_info[ix].power_consumption=="0.00"))
//				if (plug_info.status=="off"||plug_info.power_consumption=="0.00"){
				if(!this.power_consumption_good(plug_info)){
//					tell_nick._send_notif("i see Loudmouth is off.. if you forget to turn it back on i'll turn it back on in 3hrs from now","Loudmouth is off");
	...
	// 					this.set_timer_and_toggle_plug(plug_info.plug_id,60000*6); // setting timer to tick in 1*5 min.s
